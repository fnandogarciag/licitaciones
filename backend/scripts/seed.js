...
async function run() {
  ...
  try {
    const dsMod = require(path.join(base, out, 'data-source.js'));
    const AppDataSource =
    ...
    const Entidad = firstClass(
      require(path.join(base, out, 'entities', 'entidad.entity.js')),
    );
    const EstadoProceso = firstClass(
      require(path.join(base, out, 'entities', 'estado_proceso.entity.js')),
    );
    const TipoProceso = firstClass(
      require(path.join(base, out, 'entities', 'tipo_proceso.entity.js')),
    );
    const TipoFechaProceso = firstClass(
      require(path.join(base, out, 'entities', 'tipo_fecha_proceso.entity.js')),
    );
    const Proceso = firstClass(
      require(path.join(base, out, 'entities', 'proceso.entity.js')),
    );
    const FechaProceso = firstClass(
      require(path.join(base, out, 'entities', 'fecha_proceso.entity.js')),
    );
    const Lote = firstClass(
      require(path.join(base, out, 'entities', 'lote.entity.js')),
    );
    const Consorcio = firstClass(
      require(path.join(base, out, 'entities', 'consorcio.entity.js')),
    );
    const Empresa = firstClass(
      require(path.join(base, out, 'entities', 'empresa.entity.js')),
    );
    const ConsorcioEmpresa = firstClass(
      require(path.join(base, out, 'entities', 'consorcio_empresa.entity.js')),
    );
    const Oferta = firstClass(
      require(path.join(base, out, 'entities', 'oferta.entity.js')),
    );
