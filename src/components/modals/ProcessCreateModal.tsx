        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-800 text-sm">
          <div>
            ...
            <input
              ...
              className={`mt-1 block w-full border px-3 py-2 rounded-md shadow-sm text-gray-900 ${
                fieldErrors.objeto
          ...
          <div>
            ...
            <select
              ...
              className={`mt-1 block w-full px-3 py-2 rounded-md shadow-sm text-gray-900 border ${
                fieldErrors.entidad
                  ? 'border-red-600 focus:ring-red-200'
                  : 'border-gray-300 focus:ring-indigo-200'
              }`}
