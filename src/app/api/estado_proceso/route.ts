...
import { EstadoProcesoService } from '@modules/estado_proceso/estado_proceso.service';

let service: EstadoProcesoService | null = null;
const getService = () => {
  if (!service) service = new EstadoProcesoService();
  return service;
};
