...
import type { Entidad } from '@/src/entities/entidad.entity';
...
export class EntidadesService {
  ...
  private get repo() {
    return this.dataSource.getRepository('entidades');
  }
  ...
  async create(data: Partial<Entidad>) {
    await this.ensureInitialized();
    const entity = this.repo.create(data);
    return this.repo.save(entity);
  }

  async update(id: number, data: Partial<Entidad>) {
    await this.ensureInitialized();
